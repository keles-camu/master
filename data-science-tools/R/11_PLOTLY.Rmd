...
Es importante tener en mente que, para utilizar un *dataset* en la función \"plot_ly\", deberá utilizarse **el argumento \"data\"** y siempre que llamemos a una variable del *dataframe* para ser representada, debe utilizarse **el símbolo \~**.
...
Como podemos comprobar, el parámetro x es tomado como índice y, por ello, el valor 4 está vacío. Este hecho no afecta a los diagramas de barras con variables categóricas.
