...
Para aplicar sentencias condicionales en R dispone de los siguientes comandos **if** y **else**. Se propondrá un primer ejemplo simple: Si un número es mayor que 5 lo multiplicamos por 2, si no, lo dividimos entre 2.
...
for (item in 1:length(v)){
  ...
  if (v[item] %% 2 == 0) {
    ...
    print(item * v[item]) #Multiplica el item por el nº de posición que ocupa en el vector
