...
Basado en el libro *The Grammar of Graphics*, **Ggplot2** es una librería de visualización de datos que trabaja a nivel de capa, es decir, nos permite ir añadiendo nuevos elementos estéticos a nuestra visualización de datos.
...
**Añadiendo smooth** a una gráfica. El *smooth* será la zona coloreada de gris, la cual corresponderá al intervalo de confianza 95 de una regresión lineal.
