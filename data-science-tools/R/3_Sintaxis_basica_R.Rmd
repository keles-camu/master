...
En algunas ocasiones, nos encontraremos con que hemos almacenado objetos demasiado grandes en memoria, que una vez realizada una operación, deseamos eliminar. Para ello, disponemos de la función **`rm`**, a la cual pasaremos como parámetro el nombre de la variable a eliminar.
